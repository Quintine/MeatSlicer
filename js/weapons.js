...
const WEAPONS = {
  ...
  repeater:    { id: 'repeater',    name: 'Ribcage Repeater', held: 52, torsoW: 120, torsoFwd: 20, muzzle: 70, tier: 0,  ammo: 140,      interval: 0.09, dmg: 6,  spd: 560, spread: 0.10, range: 0.42, behavior: 'bullet', sprite: 'bullet_bone', sfx: 'rapid', punch: 0.18, desc: 'Rattles off rib slivers' },
  marrow:      { id: 'marrow',      name: 'Marrow Scatter',   held: 54, torsoW: 120, torsoFwd: 20, muzzle: 69, tier: 0,  ammo: 42,       interval: 0.58, dmg: 11, spd: 500, pellets: 6, spread: 0.55, range: 0.38, behavior: 'spread', sprite: 'bullet_bone', sfx: 'spread', punch: 0.92, desc: 'A devastating close blast of jagged bone' },
  cleaver:     { id: 'cleaver',     name: 'Cleaver Cadence',  held: 60, torsoW: 124, torsoFwd: 21, muzzle: 73, tier: 0,  ammo: 34,       interval: 0.38, dmg: 15, spd: 400, range: 1.10, behavior: 'boomerang',   sprite: 'bullet_cleaver', sfx: 'boomerang', punch: 0.42, desc: 'It always comes back' },
  saw:         { id: 'saw',         name: 'Sawblade Launcher',held: 52, torsoW: 118, torsoFwd: 20, muzzle: 70, tier: 1,  ammo: 26,       interval: 0.34, dmg: 13, spd: 360, bounces: 5, range: 0.60, behavior: 'bounce', sprite: 'bullet_saw', sfx: 'saw', punch: 0.45, desc: 'Bouncing, hungry steel' },
  bile:        { id: 'bile',        name: 'Bile Blunderbuss', held: 54, torsoW: 118, torsoFwd: 20, muzzle: 68, tier: 1,  ammo: 70,       interval: 0.12, dmg: 7,  spd: 340, spread: 0.32, range: 0.38, behavior: 'cone', sprite: 'bullet_gore', sfx: 'flame', punch: 0.34, desc: 'A brutal corrosive torrent; pools linger' },
  hemophage:   { id: 'hemophage',   name: 'Hemophage',        held: 50, torsoW: 116, torsoFwd: 19, muzzle: 67, tier: 1,  ammo: 44,       interval: 0.19, dmg: 8,  spd: 480, lifesteal: 0.5, range: 0.45, behavior: 'bullet', sprite: 'bullet_syringe', sfx: 'default', punch: 0.35, desc: 'Drinks what it touches' },
  eye:         { id: 'eye',         name: 'Eye Ballista',     held: 58, torsoW: 120, torsoFwd: 20, muzzle: 70, tier: 1,  ammo: 32,       interval: 0.30, dmg: 10, spd: 320, range: 0.62, behavior: 'homing',      sprite: 'bullet_eye',     sfx: 'default', punch: 0.40, desc: 'The eyes follow. They always follow' },
  guthook:     { id: 'guthook',     name: 'Gut Hook',         held: 64, torsoW: 128, torsoFwd: 22, muzzle: 76, tier: 2,  ammo: 14,       interval: 0.85, dmg: 48, spd: 720, range: 0.60, behavior: 'pierce_drag', sprite: 'bullet_harpoon', sfx: 'heavy', punch: 0.95, desc: 'Impales and drags the catch' },
  cauterizer:  { id: 'cauterizer',  name: 'The Cauterizer',   held: 58, torsoW: 128, torsoFwd: 22, muzzle: 76, tier: 2,  ammo: 110,      interval: 0.05, dmg: 4.5, spd: 310, spread: 0.34, range: 0.36, behavior: 'flame', sprite: 'bullet_gore', sfx: 'flame', punch: 0.32, desc: 'Incinerates anything brave enough to get close' },
  fleshmasher: { id: 'fleshmasher', name: 'Flesh Masher',     held: 62, torsoW: 128, torsoFwd: 22, muzzle: 76, tier: 2,  ammo: 14,       interval: 0.75, dmg: 34, spd: 999, behavior: 'lob',         sprite: 'bullet_gore',    sfx: 'lob', punch: 0.90, desc: 'Lobs ground-meat bombs' },
  trapqueen:   { id: 'trapqueen',   name: 'Trap Queen',       held: 58, torsoW: 124, torsoFwd: 21, muzzle: 73, tier: 2,  ammo: 12,       interval: 0.55, dmg: 10, spd: 999, behavior: 'lob_trap',    sprite: 'bullet_saw',     sfx: 'lob', punch: 0.65, ammoWeight: 0.75, desc: 'Bear traps. For bears. And worse' },
  tenderizer:  { id: 'tenderizer',  name: 'The Tenderizer',   held: 66, torsoW: 132, torsoFwd: 23, muzzle: 78, tier: 2,  ammo: 26,       interval: 0.58, dmg: 60, spd: 0,   behavior: 'slam',        sprite: 'bullet_bone',    sfx: 'heavy', punch: 1.00, desc: 'A room-shaking close-range meat paste' },
  redhand:     { id: 'redhand',     name: 'Red Right Hand',   held: 68, torsoW: 134, torsoFwd: 24, muzzle: 80, tier: 2,  ammo: 160,      interval: 0.10, dmg: 7,  spd: 0,   behavior: 'saw',         sprite: 'bullet_saw',     sfx: 'saw', punch: 0.38, desc: 'A chainsaw that liquefies anything in reach' },
  spinaltap:   { id: 'spinaltap',   name: 'Spinal Tap',       held: 68, torsoW: 136, torsoFwd: 24, muzzle: 81, tier: 3,  ammo: 9,        interval: 0.30, dmg: 95, spd: 0,   chargeTime: 0.85, behavior: 'beam', sprite: 'bullet_bone', sfx: 'beam', punch: 1.00, desc: 'Charge it. Delete a line of meat' },
  swarmjar:    { id: 'swarmjar',    name: 'Swarm Jar',        held: 62, torsoW: 124, torsoFwd: 21, muzzle: 73, tier: 3,  ammo: 7,        interval: 0.80, dmg: 9,  spd: 999, behavior: 'lob_swarm',   sprite: 'bullet_gore',    sfx: 'lob', punch: 0.70, ammoWeight: 0.8, desc: 'A jar of friends. They are hungry' },
};
...
// continuous chainsaw damage while held (def = weapon stats, inst = ammo holder)
