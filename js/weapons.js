...
const WEAPONS = {
  ...
  cleaver:     { id: 'cleaver',     name: 'Cleaver Cadence',  held: 60, torsoW: 124, torsoFwd: 21, muzzle: 73, tier: 1,  ammo: 34,       interval: 0.38, dmg: 15, spd: 400, range: 1.10, behavior: 'boomerang',   sprite: 'bullet_cleaver', sfx: 'boomerang', punch: 0.42, desc: 'It always comes back' },
  ...
  bile:        { id: 'bile',        name: 'Bile Blunderbuss', held: 54, torsoW: 118, torsoFwd: 20, muzzle: 68, tier: 2,  ammo: 70,       interval: 0.12, dmg: 7,  spd: 340, spread: 0.32, range: 0.38, behavior: 'cone', sprite: 'bullet_gore', sfx: 'flame', punch: 0.34, desc: 'A brutal corrosive torrent; pools linger' },
  ...
  cauterizer:  { id: 'cauterizer',  name: 'The Cauterizer',   held: 58, torsoW: 128, torsoFwd: 22, muzzle: 76, tier: 3,  ammo: 110,      interval: 0.05, dmg: 4.5, spd: 310, spread: 0.34, range: 0.36, behavior: 'flame', sprite: 'bullet_gore', sfx: 'flame', punch: 0.32, desc: 'Incinerates anything brave enough to get close' },
  ...
  tenderizer:  { id: 'tenderizer',  name: 'The Tenderizer',   held: 66, torsoW: 132, torsoFwd: 23, muzzle: 78, tier: 3,  ammo: 26,       interval: 0.58, dmg: 60, spd: 0,   behavior: 'slam',        sprite: 'bullet_bone',    sfx: 'heavy', punch: 1.00, desc: 'A room-shaking close-range meat paste' },
